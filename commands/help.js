...
module.exports = {
  ...
  async execute(interaction) {
    const embed = new EmbedBuilder()
      ...
      .setDescription('Voici toutes les **7** commandes disponibles :')
      .addFields(
        ...
        { name: '`/clear <nombre>`', value: 'Supprimer 1 à 99 messages (1-99)', inline: false },
        ...
        { name: '`/help`', value: 'Afficher ce message (oui, c’est moi)', inline: false }
      )
      .setFooter({ 
        text: `TFC Bot • 7 commandes • En ligne 24/7`, 
